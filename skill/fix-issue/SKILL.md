---
name: fix-issue
description: Fix a microsoft/vscode issue that the VS Code Sweeper reviewed as agent-fixable. Fetches the review's fix spec from the sweeper's public state repo, implements the narrow fix in the current vscode checkout, and — after showing the diff — opens a draft PR. Use when asked to fix a vscode issue with the fix-issue skill, a vscodesweeper record, or a sweeper fix spec.
---

<!-- Generated by vscodesweeper (fix-issue skill v1) — do not edit by hand.
     Source: prompts/fix-issue-skill.md in the vscodesweeper repo; getting started:
     https://egamma.github.io/vscodesweeper-state/fix-skill.html -->

# fix-issue — implement a sweeper-reviewed fix
