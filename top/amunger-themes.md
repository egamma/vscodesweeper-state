...
Experimental themed view of [the flat ranking](amunger.md); themes assigned by the review engine. Rank/score are the lane-wide values. Generated 2026-08-03 15:18 UTC.
...
| 15 | [#314134](https://github.com/microsoft/vscode/issues/314134) | [Error] unhandlederror-Cannot read properties of null (reading 'domNode') | 0 | crash | 5/6 Source-confirmed | 22 | — | — |
...
| # | Issue | Title | 👍 | Severity | Rating | Score | Agent-fixable | Draft PR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | [#324857](https://github.com/microsoft/vscode/issues/324857) | Intermittent Jupyter Interactive Window Hangs and Extension Host Instability After VS Code Update to 1.127.0 | 0 | none | 3/6 Plausible | 22 | — | — |
