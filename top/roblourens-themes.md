...
Experimental themed view of [the flat ranking](roblourens.md); themes assigned by the review engine. Rank/score are the lane-wide values. Generated 2026-08-03 15:53 UTC.

## Bugs

### Agent mode control (51)
...
| 163 | [#299313](https://github.com/microsoft/vscode/issues/299313) | Steering issue / double agent session in the same chat | 0 | correctness | 3/6 Plausible | 2 | — | — |
| 220 | [#300790](https://github.com/microsoft/vscode/issues/300790) | Endless reasoning, hallucinations | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 221 | [#300958](https://github.com/microsoft/vscode/issues/300958) | the work keeps being interrupted | 0 | none | 3/6 Plausible | 1 | — | — |
| 230 | [#305627](https://github.com/microsoft/vscode/issues/305627) | Response stuck in a loop in agent mode | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 231 | [#305932](https://github.com/microsoft/vscode/issues/305932) | Forever loop in chat, session list shows Failed. | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 232 | [#306017](https://github.com/microsoft/vscode/issues/306017) | Copilot does not realize it's in ask mode | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 237 | [#308542](https://github.com/microsoft/vscode/issues/308542) | not able to reset/stop agent | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 245 | [#316051](https://github.com/microsoft/vscode/issues/316051) | Copilot Chat Agent uses wrong session/file context when multiple chat sessions are active | 0 | correctness | 4/6 Traced | 1 | — | — |
| 271 | [#327586](https://github.com/microsoft/vscode/issues/327586) | Agent Mode / Copilot CLI delivered identical user prompt twice in one session | 0 | correctness | 5/6 Source-confirmed | 1 | yes | — |
| 299 | [#275451](https://github.com/microsoft/vscode/issues/275451) | Ask mode sometimes thinks it can edit | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 327 | [#301083](https://github.com/microsoft/vscode/issues/301083) | Yes, Ok, The end. infinite loop | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 328 | [#301106](https://github.com/microsoft/vscode/issues/301106) | Grok Code Fast trapped in weird hallucination loop | 0 | none | — | 0 | — | — |
| 330 | [#301309](https://github.com/microsoft/vscode/issues/301309) | Agent has forgotten it has tools? | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 338 | [#301818](https://github.com/microsoft/vscode/issues/301818) | "it" word repeated non-stop in reasoning | 0 | none | 3/6 Plausible | 0 | — | — |
| 339 | [#302013](https://github.com/microsoft/vscode/issues/302013) | When submitting a copilot chat request one or more new vscode windows open and begin processing an old copilot chat session that was already complete. | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 343 | [#302369](https://github.com/microsoft/vscode/issues/302369) | Agent vs Plan modes mix up on multiple chats | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 349 | [#303111](https://github.com/microsoft/vscode/issues/303111) | Agent looped whith "done" reccursive into and infinite loop | 0 | none | 3/6 Plausible | 0 | — | — |
| 350 | [#303112](https://github.com/microsoft/vscode/issues/303112) | Agent looped whith "done" reccursive into and infinite loop | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 352 | [#303378](https://github.com/microsoft/vscode/issues/303378) | Agent was looping over the same information | 0 | none | 3/6 Plausible | 0 | — | — |
| 353 | [#303479](https://github.com/microsoft/vscode/issues/303479) | Looping again | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 358 | [#305044](https://github.com/microsoft/vscode/issues/305044) | Over and Over again | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 359 | [#305046](https://github.com/microsoft/vscode/issues/305046) | Copilot Chat Agent alway make fake response | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 361 | [#305143](https://github.com/microsoft/vscode/issues/305143) | GPT-5.3 Codex does not call any tools | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 369 | [#312343](https://github.com/microsoft/vscode/issues/312343) | Todo lists are intermittently (but frequently) left incomplete | 0 | visual | 3/6 Plausible | 0 | — | — |
| 373 | [#313144](https://github.com/microsoft/vscode/issues/313144) | Agent mode stops before completing tasks with Claude Sonnet 4.6, logs show Unknown content_block type 'text' | 0 | papercut | 2/6 Unverified | 0 | — | — |
| 387 | [#317827](https://github.com/microsoft/vscode/issues/317827) | Agent window: other modes should be disabled in sub agent if it is not supported | 0 | papercut | 3/6 Plausible | 0 | — | — |
| 391 | [#318924](https://github.com/microsoft/vscode/issues/318924) | Copilot resumes chat when it should not | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 395 | [#320463](https://github.com/microsoft/vscode/issues/320463) | "steering" the agent during execution dumped the entire session into the comment | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 405 | [#324083](https://github.com/microsoft/vscode/issues/324083) | Agents: forked session stuck when making edits+asking question | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 409 | [#325287](https://github.com/microsoft/vscode/issues/325287) | Copilot Chat — Agent mode silently active despite Ask mode selected | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 410 | [#325290](https://github.com/microsoft/vscode/issues/325290) | Copilot Chat — Agent mode silently active despite Ask mode selected | 0 | none | 3/6 Plausible | 0 | — | — |
| 412 | [#325432](https://github.com/microsoft/vscode/issues/325432) | [security] GitHib Copilot cannot be stopped or canceled | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 415 | [#325884](https://github.com/microsoft/vscode/issues/325884) | Agent Host: editing a steering message when it's in a pending state causes all versions to be sent | 0 | correctness | — | 0 | — | — |
| 418 | [#326603](https://github.com/microsoft/vscode/issues/326603) | Copilot Agent Mode can stream stale previous-task response under a new user turn after cancel/resend | 0 | correctness | 6/6 Confirmed | 0 | — | — |
| 421 | [#326804](https://github.com/microsoft/vscode/issues/326804) | Copilot agent switches to Plan mode and can't switch back | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 427 | [#328340](https://github.com/microsoft/vscode/issues/328340) | [Regression in 1.131] vscode_askQuestions auto-fills "user is not available" instead of prompting; Plan mode also auto-switches to Agent | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 428 | [#328430](https://github.com/microsoft/vscode/issues/328430) | Github Copilot change from Agent to Plan Mode triggers "Start Implementation" | 0 | correctness | 6/6 Confirmed | 0 | — | — |
| 431 | [#328552](https://github.com/microsoft/vscode/issues/328552) | Agent's questions timed out? in Chat window | 0 | correctness | 6/6 Confirmed | 0 | — | — |
...
| 155 | [#285238](https://github.com/microsoft/vscode/issues/285238) | workbench is missing | 0 | none | 3/6 Plausible | 2 | — | — |
| 156 | [#286284](https://github.com/microsoft/vscode/issues/286284) | 'fetch failed' with no 'try again' | 0 | papercut | 5/6 Source-confirmed | 2 | — | — |
| 158 | [#288005](https://github.com/microsoft/vscode/issues/288005) | Agent mode crashes | 0 | none | 3/6 Plausible | 2 | — | — |
| 160 | [#295160](https://github.com/microsoft/vscode/issues/295160) | Stuck in activating | 0 | freeze | 3/6 Plausible | 2 | — | — |
| 183 | [#300081](https://github.com/microsoft/vscode/issues/300081) | Stalling | 1 | none | 3/6 Plausible | 1 | — | — |
| 184 | [#324004](https://github.com/microsoft/vscode/issues/324004) | Copilot not working | 1 | none | 3/6 Plausible | 1 | — | — |
| 248 | [#317190](https://github.com/microsoft/vscode/issues/317190) | "Copilot failed to get ready" | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 296 | [#254332](https://github.com/microsoft/vscode/issues/254332) | hung up spinning | 0 | freeze | 3/6 Plausible | 0 | — | — |
| 303 | [#287579](https://github.com/microsoft/vscode/issues/287579) | Chat took too long to get ready | 0 | perf | 3/6 Plausible | 0 | — | — |
| 304 | [#287641](https://github.com/microsoft/vscode/issues/287641) | Chat took too long to get ready | 0 | perf | 3/6 Plausible | 0 | — | — |
| 305 | [#287774](https://github.com/microsoft/vscode/issues/287774) | Chat took too long to get ready | 0 | papercut | 3/6 Plausible | 0 | — | — |
| 306 | [#287810](https://github.com/microsoft/vscode/issues/287810) | Chat took too long to get ready | 0 | papercut | 3/6 Plausible | 0 | — | — |
| 307 | [#288017](https://github.com/microsoft/vscode/issues/288017) | Chat took too long to get ready | 0 | none | 3/6 Plausible | 0 | — | — |
| 308 | [#288098](https://github.com/microsoft/vscode/issues/288098) | Chat took too long to get ready | 0 | none | 3/6 Plausible | 0 | — | — |
| 309 | [#288099](https://github.com/microsoft/vscode/issues/288099) | Chat took too long to get ready | 0 | none | 3/6 Plausible | 0 | — | — |
| 310 | [#288525](https://github.com/microsoft/vscode/issues/288525) | Chat took too long to get ready | 0 | none | 3/6 Plausible | 0 | — | — |
| 311 | [#288543](https://github.com/microsoft/vscode/issues/288543) | Chat took too long to get ready | 0 | perf | 3/6 Plausible | 0 | — | — |
| 312 | [#288544](https://github.com/microsoft/vscode/issues/288544) | Chat took too long to get ready | 0 | perf | 3/6 Plausible | 0 | — | — |
| 313 | [#288744](https://github.com/microsoft/vscode/issues/288744) | Chat took too long to get ready | 0 | none | 3/6 Plausible | 0 | — | — |
| 314 | [#289113](https://github.com/microsoft/vscode/issues/289113) | Chat took too long to get ready | 0 | papercut | 3/6 Plausible | 0 | — | — |
| 315 | [#289291](https://github.com/microsoft/vscode/issues/289291) | Chat took too long to get ready | 0 | perf | 3/6 Plausible | 0 | — | — |
| 316 | [#289884](https://github.com/microsoft/vscode/issues/289884) | Chat took too long to get ready | 0 | perf | 3/6 Plausible | 0 | — | — |
| 318 | [#291783](https://github.com/microsoft/vscode/issues/291783) | Chat took too long to get ready | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 319 | [#291857](https://github.com/microsoft/vscode/issues/291857) | Chat took too long to get ready | 0 | papercut | 3/6 Plausible | 0 | — | — |
| 320 | [#291858](https://github.com/microsoft/vscode/issues/291858) | Chat took too long to get ready | 0 | papercut | 3/6 Plausible | 0 | — | — |
| 322 | [#293803](https://github.com/microsoft/vscode/issues/293803) | Silent failure | 0 | none | 3/6 Plausible | 0 | — | — |
| 323 | [#295743](https://github.com/microsoft/vscode/issues/295743) | Stalled on asking questions for 10 minutes without completing nor timeouting | 0 | freeze | 3/6 Plausible | 0 | — | — |
| 324 | [#299704](https://github.com/microsoft/vscode/issues/299704) | Build failed: Copilot Chat Sanity Test timeout | 0 | correctness | — | 0 | — | — |
| 331 | [#301469](https://github.com/microsoft/vscode/issues/301469) | Claude Agent Mode stuck in Thinking step | 0 | none | 3/6 Plausible | 0 | — | — |
| 340 | [#302249](https://github.com/microsoft/vscode/issues/302249) | Sub agent keeps getting stuck | 0 | freeze | 3/6 Plausible | 0 | — | — |
| 345 | [#302636](https://github.com/microsoft/vscode/issues/302636) | it is showing error | 0 | none | 3/6 Plausible | 0 | — | — |
| 346 | [#302686](https://github.com/microsoft/vscode/issues/302686) | Copilot Chat is not openning on VSC | 0 | none | 3/6 Plausible | 0 | — | — |
| 357 | [#304997](https://github.com/microsoft/vscode/issues/304997) | nothing happened | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 360 | [#305134](https://github.com/microsoft/vscode/issues/305134) | Not able to complete the request | 0 | none | 3/6 Plausible | 0 | — | — |
| 363 | [#306609](https://github.com/microsoft/vscode/issues/306609) | Copilot CLI non-responsive | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 364 | [#307214](https://github.com/microsoft/vscode/issues/307214) | i have this installed and it fails to work | 0 | papercut | 3/6 Plausible | 0 | — | — |
| 371 | [#313034](https://github.com/microsoft/vscode/issues/313034) | Github Copilot Session Error | 0 | data-loss | 2/6 Unverified | 0 | — | — |
| 374 | [#313202](https://github.com/microsoft/vscode/issues/313202) | Chat took too long to get ready | 0 | papercut | 3/6 Plausible | 0 | — | — |
| 379 | [#315872](https://github.com/microsoft/vscode/issues/315872) | Copilot chat stalling when invoking an agent defined in a web extension | 0 | crash | 3/6 Plausible | 0 | — | — |
| 399 | [#320726](https://github.com/microsoft/vscode/issues/320726) | My AI FROM VS CODE  IS NOT WORKING | 0 | none | 3/6 Plausible | 0 | — | — |
| 426 | [#327886](https://github.com/microsoft/vscode/issues/327886) | Copilot agent hangs mid-task with no progress and no user-visible output (worked around by killing the VS Code application) | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |

### Session persistence (32)
...
| 161 | [#295377](https://github.com/microsoft/vscode/issues/295377) | Thinking titles are sometimes not saved | 0 | correctness | 5/6 Source-confirmed | 2 | yes | — |
| 223 | [#301777](https://github.com/microsoft/vscode/issues/301777) | Codexとの会話履歴が復元できない | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 226 | [#303759](https://github.com/microsoft/vscode/issues/303759) | Chat history disappears ONLY when I click or open another tab on VS Code | 0 | none | 3/6 Plausible | 1 | — | — |
| 260 | [#325673](https://github.com/microsoft/vscode/issues/325673) | Agent host: Delete... on a Claude session doesn't delete the SDK transcript — session resurrects on next list refresh | 0 | correctness | 5/6 Source-confirmed | 1 | — | — |
| 269 | [#327091](https://github.com/microsoft/vscode/issues/327091) | Session history lost. | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 270 | [#327487](https://github.com/microsoft/vscode/issues/327487) | Forked Copilot Sessions Merged Again | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 367 | [#312306](https://github.com/microsoft/vscode/issues/312306) | Copilot Chat session appeared to reset/crash during multi-step documentation workflow | 0 | none | 3/6 Plausible | 0 | — | — |
| 388 | [#318408](https://github.com/microsoft/vscode/issues/318408) | Selected model in a session isn't always preserved on Reload | 0 | correctness | 4/6 Traced | 0 | — | — |
| 392 | [#319599](https://github.com/microsoft/vscode/issues/319599) | message sent to local CLI with editor chat will create two session entries | 0 | visual | 3/6 Plausible | 0 | — | — |
| 400 | [#320731](https://github.com/microsoft/vscode/issues/320731) | VS Code Error: "Error serializing chat session for storage" | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 401 | [#322521](https://github.com/microsoft/vscode/issues/322521) | Session disappears from session list | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 403 | [#323679](https://github.com/microsoft/vscode/issues/323679) | Session file corrupted: negative data.tokensRemoved rejected by SDK ("Number must be greater than or equal to 0") | 0 | data-loss | — | 0 | — | — |
| 406 | [#324249](https://github.com/microsoft/vscode/issues/324249) | Copilot Chat session is lost after VS Code crash only when workspace is opened via \\wsl.localhost on Windows (no Remote-WSL) | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 408 | [#324662](https://github.com/microsoft/vscode/issues/324662) | Copilot Chat history item silently fails to load when chatSessions JSONL is missing but session-store.db has transcript | 0 | papercut | 4/6 Traced | 0 | — | — |
| 414 | [#325822](https://github.com/microsoft/vscode/issues/325822) | Critical: Chat session data lost when computer sleeps - Data loss + Financial loss | 0 | data-loss | 3/6 Plausible | 0 | — | — |
| 417 | [#326494](https://github.com/microsoft/vscode/issues/326494) | Archived Agent Host sessions should be read-only in editor chat | 0 | correctness | 6/6 Confirmed | 0 | — | — |
| 422 | [#326857](https://github.com/microsoft/vscode/issues/326857) | When I close the VScode application, my chat with the AI in VScode is lost. This has been occuring for the last ~3 monthsI have the github copilot plus subscription. Aditionally, when the token associated with my github copilot are depleted, the AI in VScode will lock and not allow even use of the free AI tokens for non-github colpiot uses, the AI simple tells me the monthly limit is reached and blcks all AI usage until the start of the following month. THis behavior has been during last month and this month. | 0 | data-loss | 3/6 Plausible | 0 | — | — |
| 425 | [#327787](https://github.com/microsoft/vscode/issues/327787) | Export and Import chat currently not retain session info after opening and closing | 0 | data-loss | 5/6 Source-confirmed | 0 | — | — |
| 429 | [#328444](https://github.com/microsoft/vscode/issues/328444) | Session irreversibly lost after changes to workspace folder and saving workspace | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
...
| 151 | [#242930](https://github.com/microsoft/vscode/issues/242930) | Powershell extension activated for a chat terminal command | 0 | papercut | 5/6 Source-confirmed | 2 | — | — |
| 152 | [#264416](https://github.com/microsoft/vscode/issues/264416) | Custom instructions sometimes removed during summarization | 0 | correctness | 3/6 Plausible | 2 | — | — |
| 153 | [#275218](https://github.com/microsoft/vscode/issues/275218) | Anthropic BYOK leaves incomplete sentence before tool call | 0 | visual | 5/6 Source-confirmed | 2 | — | — |
| 154 | [#275408](https://github.com/microsoft/vscode/issues/275408) | Most recent Codex session shows persistent loading indicator in chat sessions view | 0 | visual | 3/6 Plausible | 2 | — | — |
| 157 | [#287844](https://github.com/microsoft/vscode/issues/287844) | Copilot Agent create_file fails on NTFS data drive (D:) but works on C:\ and Dev Drive (ReFS) | 0 | correctness | 3/6 Plausible | 2 | — | — |
| 159 | [#289826](https://github.com/microsoft/vscode/issues/289826) | Agent: Search subagent isn't finding what I need chain of failures | 0 | correctness | 3/6 Plausible | 2 | — | — |
| 162 | [#295543](https://github.com/microsoft/vscode/issues/295543) | Canceling the context of the currently resolved matter in the VS Code Copilot Pro chat | 0 | none | 3/6 Plausible | 2 | — | — |
| 164 | [#300625](https://github.com/microsoft/vscode/issues/300625) | Input/output confirmation cuts off text | 0 | visual | 5/6 Source-confirmed | 2 | yes | — |
| 165 | [#303468](https://github.com/microsoft/vscode/issues/303468) | Infinite Loop | 0 | none | 3/6 Plausible | 2 | — | — |
| 166 | [#304754](https://github.com/microsoft/vscode/issues/304754) | Rambling on. | 0 | correctness | 3/6 Plausible | 2 | — | — |
| 167 | [#305100](https://github.com/microsoft/vscode/issues/305100) | Copilot is not working at all in MAC | 0 | none | 3/6 Plausible | 2 | — | — |
| 168 | [#305553](https://github.com/microsoft/vscode/issues/305553) | Some invalid str issue came in copilot | 0 | correctness | 3/6 Plausible | 2 | — | — |
| 169 | [#312976](https://github.com/microsoft/vscode/issues/312976) | Copilot CLI with worktree mode made local changes | 0 | correctness | 3/6 Plausible | 2 | — | — |
| 170 | [#315314](https://github.com/microsoft/vscode/issues/315314) | Hydrating large chat session items block renderer during startup | 0 | perf | 3/6 Plausible | 2 | — | — |
| 171 | [#320471](https://github.com/microsoft/vscode/issues/320471) | Copilot stuck | 0 | correctness | 3/6 Plausible | 2 | — | — |
| 172 | [#324141](https://github.com/microsoft/vscode/issues/324141) | Extension host crashed due to GitHub Copilot Chat | 0 | crash | 3/6 Plausible | 2 | — | — |
| 173 | [#324907](https://github.com/microsoft/vscode/issues/324907) | Copilot Agent built-in list_dir returns unbounded output for large directories and freezes/poisons the chat session | 0 | freeze | 5/6 Source-confirmed | 2 | yes | — |
| 174 | [#326466](https://github.com/microsoft/vscode/issues/326466) | GPT-5.6 Sol: background subagent result is lost after parent ends waiting turn | 0 | correctness | 6/6 Confirmed | 2 | — | — |
| 175 | [#326653](https://github.com/microsoft/vscode/issues/326653) | Agent-host planning session abruptly ends and becomes unresponsive | 0 | freeze | 6/6 Confirmed | 2 | — | — |
| 176 | [#327415](https://github.com/microsoft/vscode/issues/327415) | Blocked: `net::ERR_CONNECTION_CLOSED` for every plan write attempt on GitHub Copilot | 0 | correctness | 6/6 Confirmed | 2 | — | — |
| 177 | [#129425](https://github.com/microsoft/vscode/issues/129425) | Chosen user-settings debug launch configuration not remembered | 2 | papercut | 5/6 Source-confirmed | 1 | yes | — |
| 178 | [#204391](https://github.com/microsoft/vscode/issues/204391) | Debug Console filter with Go is difficult to use and inaccurate | 2 | papercut | 3/6 Plausible | 1 | — | — |
| 179 | [#140980](https://github.com/microsoft/vscode/issues/140980) | Debug targets that don't exist in launch.json | 1 | papercut | 4/6 Traced | 1 | yes | — |
| 180 | [#210854](https://github.com/microsoft/vscode/issues/210854) | Changing lettercase of directory causes unbound breakpoints as VSCode does not refresh path | 1 | correctness | 5/6 Source-confirmed | 1 | yes | — |
| 181 | [#225594](https://github.com/microsoft/vscode/issues/225594) | `Load More Stack Frames` renders poorly when horizontalScrolling enabled | 1 | visual | 5/6 Source-confirmed | 1 | yes | — |
| 182 | [#229888](https://github.com/microsoft/vscode/issues/229888) | [Bug] OS-Level Launch Configuration Not Behaving As Expected | 1 | correctness | 2/6 Unverified | 1 | — | — |
| 185 | [#85290](https://github.com/microsoft/vscode/issues/85290) | Debugging should handle identical sources in sourceReference better | 0 | correctness | 4/6 Traced | 1 | — | — |
| 186 | [#117554](https://github.com/microsoft/vscode/issues/117554) | When processing setBreakpoints response treat undefined source.path the same as undefined source | 0 | correctness | 4/6 Traced | 1 | yes | — |
| 187 | [#128744](https://github.com/microsoft/vscode/issues/128744) | DAP ContinuedEvent with allThreadsContinued=true causes selected debug session to change | 0 | papercut | 4/6 Traced | 1 | — | — |
...
| 189 | [#131655](https://github.com/microsoft/vscode/issues/131655) | [UI/UX] problem with disassembly page. | 0 | visual | 5/6 Source-confirmed | 1 | yes | — |
| 190 | [#153480](https://github.com/microsoft/vscode/issues/153480) | Stopping debug while pre-launch task runs causes popups | 0 | papercut | 3/6 Plausible | 1 | — | — |
| 191 | [#156351](https://github.com/microsoft/vscode/issues/156351) | Confusing dialog for contributed launch configs when errors occur | 0 | papercut | 5/6 Source-confirmed | 1 | — | — |
| 192 | [#156842](https://github.com/microsoft/vscode/issues/156842) | Restarting a Debug Adapter doesn't reset the Visual Studio Interface | 0 | correctness | 5/6 Source-confirmed | 1 | yes | — |
| 193 | [#164957](https://github.com/microsoft/vscode/issues/164957) | "Load More Stack Frames" is incorrectly displayed after debug adapter has sent the full stack | 0 | visual | 5/6 Source-confirmed | 1 | yes | — |
| 194 | [#171446](https://github.com/microsoft/vscode/issues/171446) | Problems pane gives incorrect advice about `launch.json`. | 0 | correctness | 2/6 Unverified | 1 | — | — |
| 195 | [#180488](https://github.com/microsoft/vscode/issues/180488) | DAP error response handling is confusing and inconsistent | 0 | correctness | 5/6 Source-confirmed | 1 | yes | — |
| 196 | [#196009](https://github.com/microsoft/vscode/issues/196009) | DebugAdapterTracker not working in web extensions | 0 | correctness | 5/6 Source-confirmed | 1 | — | — |
| 197 | [#204841](https://github.com/microsoft/vscode/issues/204841) | saving the .code-workspace resets the currently selected launch config from that file | 0 | correctness | 5/6 Source-confirmed | 1 | yes | — |
| 198 | [#243477](https://github.com/microsoft/vscode/issues/243477) | Variables/Watch 'F2' for 'Set Value' is broken | 0 | correctness | 5/6 Source-confirmed | 1 | yes | — |
| 199 | [#244875](https://github.com/microsoft/vscode/issues/244875) | Stopping hanging hot restart in Flutter breaks F5 start debugging key | 0 | correctness | 4/6 Traced | 1 | yes | — |
| 200 | [#247340](https://github.com/microsoft/vscode/issues/247340) | Some active breakpoints can be removed only from the Breakpoints menu | 0 | visual | 5/6 Source-confirmed | 1 | yes | — |
| 201 | [#248911](https://github.com/microsoft/vscode/issues/248911) | UI Flicker Observed During Image Rendering in VS Code Copilot Extension | 0 | visual | 6/6 Confirmed | 1 | — | — |
| 202 | [#252133](https://github.com/microsoft/vscode/issues/252133) | RangeError [ERR_CHILD_PROCESS_STDIO_MAXBUFFER]: stdout maxBuffer length exceeded | 0 | papercut | 2/6 Unverified | 1 | — | — |
| 203 | [#254102](https://github.com/microsoft/vscode/issues/254102) | Missing Code suggestion in "Ask" mode while using Claude Sonnet | 0 | visual | 3/6 Plausible | 1 | — | — |
| 204 | [#265248](https://github.com/microsoft/vscode/issues/265248) | Empty chat view after disabling copilot chat extension | 0 | visual | 5/6 Source-confirmed | 1 | — | — |
| 205 | [#270016](https://github.com/microsoft/vscode/issues/270016) | Selected launch option changes when more than one source exists and either changes | 0 | papercut | 5/6 Source-confirmed | 1 | yes | — |
| 206 | [#280544](https://github.com/microsoft/vscode/issues/280544) | Agent sessions: recent sessions list flashes on first open of chat view | 0 | visual | 5/6 Source-confirmed | 1 | yes | — |
| 207 | [#283561](https://github.com/microsoft/vscode/issues/283561) | Tweak/disable thinking for GPT models and inline chat | 0 | correctness | 2/6 Unverified | 1 | — | — |
| 208 | [#284304](https://github.com/microsoft/vscode/issues/284304) | Subagent spawned by subagent inherits root tools by default, not the spawner's tools | 0 | correctness | 5/6 Source-confirmed | 1 | — | — |
| 209 | [#286093](https://github.com/microsoft/vscode/issues/286093) | Agent sessions - recent list update before session is loaded | 0 | visual | 6/6 Confirmed | 1 | — | — |
| 210 | [#291735](https://github.com/microsoft/vscode/issues/291735) | Delegate button shows background/cloud options when not in a git repository | 0 | papercut | 4/6 Traced | 1 | yes | — |
| 211 | [#292095](https://github.com/microsoft/vscode/issues/292095) | Permission to read prompt file already attached? | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 212 | [#293335](https://github.com/microsoft/vscode/issues/293335) | agent未执行完任务就结束了 | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 213 | [#293418](https://github.com/microsoft/vscode/issues/293418) | Frozen | 0 | freeze | 3/6 Plausible | 1 | — | — |
| 214 | [#295389](https://github.com/microsoft/vscode/issues/295389) | Opening Copilot Chat after crash leads to error. | 0 | correctness | 2/6 Unverified | 1 | — | — |
| 215 | [#296172](https://github.com/microsoft/vscode/issues/296172) | Tool picker live-syncs to running agent session | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 216 | [#297248](https://github.com/microsoft/vscode/issues/297248) | Fix Duplicate Labels in GitHub Copilot Agent Selector for Plan Modes | 0 | visual | 2/6 Unverified | 1 | — | — |
| 217 | [#297276](https://github.com/microsoft/vscode/issues/297276) | UI Rendering Issue: Chat sessions and history are not updating in real-time in the new Agent Sessions sidebar | 0 | correctness | 2/6 Unverified | 1 | — | — |
| 218 | [#297788](https://github.com/microsoft/vscode/issues/297788) | Adding the Workspace's chatSessions folder to the workspace prevents chat sessions from loading | 0 | correctness | 2/6 Unverified | 1 | — | — |
| 219 | [#299106](https://github.com/microsoft/vscode/issues/299106) | File got deleted despite denying the tool call | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 222 | [#301489](https://github.com/microsoft/vscode/issues/301489) | Chat entered loop | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 224 | [#303083](https://github.com/microsoft/vscode/issues/303083) | VSCode crash while using claude agent | 0 | crash | 3/6 Plausible | 1 | — | — |
| 225 | [#303113](https://github.com/microsoft/vscode/issues/303113) | Agent looped whith "done" reccursive into and infinite loop | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 227 | [#304665](https://github.com/microsoft/vscode/issues/304665) | Copilot Chat 在即使打开了 autopilot 的情况下也不操作代码，并且生成的 response 中隐藏了真正有用的信息 | 0 | none | 3/6 Plausible | 1 | — | — |
| 228 | [#304703](https://github.com/microsoft/vscode/issues/304703) | Copilot causes all extensions to crash after connection drop | 0 | freeze | 3/6 Plausible | 1 | — | — |
| 229 | [#304901](https://github.com/microsoft/vscode/issues/304901) | Still garbage! | 0 | none | 3/6 Plausible | 1 | — | — |
| 233 | [#306657](https://github.com/microsoft/vscode/issues/306657) | Simple Task Taking Forever To Finish | 0 | none | 3/6 Plausible | 1 | — | — |
| 234 | [#307419](https://github.com/microsoft/vscode/issues/307419) | VS Code asks to restart | 0 | freeze | 3/6 Plausible | 1 | — | — |
| 235 | [#307910](https://github.com/microsoft/vscode/issues/307910) | VS Code Insiders keeps crashing | 0 | freeze | 3/6 Plausible | 1 | — | — |
| 236 | [#308200](https://github.com/microsoft/vscode/issues/308200) | Chat is unresponsive | 0 | none | 3/6 Plausible | 1 | — | — |
| 238 | [#311599](https://github.com/microsoft/vscode/issues/311599) | issue with almost everything | 0 | none | 3/6 Plausible | 1 | — | — |
| 239 | [#311917](https://github.com/microsoft/vscode/issues/311917) | [Error] potential listener LEAK — textModel / codeBlockPart (chat code block rendering) | 0 | perf | 5/6 Source-confirmed | 1 | — | — |
| 240 | [#312400](https://github.com/microsoft/vscode/issues/312400) | agent mistakenly things it is in ask mode | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 241 | [#313019](https://github.com/microsoft/vscode/issues/313019) | Error when using gemini api as openai compaitable provider for vscode insiders. | 0 | correctness | — | 1 | — | — |
| 242 | [#313233](https://github.com/microsoft/vscode/issues/313233) | ## Bug Report: Command Prefix `/explain` Not Recognized | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 243 | [#313326](https://github.com/microsoft/vscode/issues/313326) | CoPilot, Stopped Working | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 244 | [#313330](https://github.com/microsoft/vscode/issues/313330) | Race between replace_string_in_file and terminal commands in chat | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 246 | [#316368](https://github.com/microsoft/vscode/issues/316368) | stop working after update | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 247 | [#316371](https://github.com/microsoft/vscode/issues/316371) | The floating text covers the button, and moving your mouse slightly to the left or right causes the button to flash. | 0 | visual | 5/6 Source-confirmed | 1 | — | — |
| 249 | [#317345](https://github.com/microsoft/vscode/issues/317345) | Bad hiding behavior of pickers in toolbar | 0 | visual | 6/6 Confirmed | 1 | — | — |
| 250 | [#317586](https://github.com/microsoft/vscode/issues/317586) | Blank | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 251 | [#317706](https://github.com/microsoft/vscode/issues/317706) | Agents app: Shows different set of available agents/skills etc. within the same workspace | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 252 | [#318362](https://github.com/microsoft/vscode/issues/318362) | debug configuration doesn't restore to last selected after Reload Window(Remote SSH, multi-repo .code-workspace) | 0 | correctness | 5/6 Source-confirmed | 1 | yes | — |
| 253 | [#318887](https://github.com/microsoft/vscode/issues/318887) | Erro de compactação mesmo em projeto pequenoi, não executa mais nada | 0 | none | — | 1 | — | — |
| 254 | [#322566](https://github.com/microsoft/vscode/issues/322566) | Renamed chat session title reverts to auto-generated name on reopen (1.126.0) | 0 | correctness | 5/6 Source-confirmed | 1 | — | — |
| 255 | [#323156](https://github.com/microsoft/vscode/issues/323156) | [Error] unhandlederror-Unknown LanguageModelIgnoredFileProvider | 0 | correctness | 5/6 Source-confirmed | 1 | — | — |
| 256 | [#324884](https://github.com/microsoft/vscode/issues/324884) | не работает чат | 0 | none | 3/6 Plausible | 1 | — | — |
| 257 | [#325034](https://github.com/microsoft/vscode/issues/325034) | Coplit crashing with out of memory - The window terminated unexpectedly (reason: 'oom', code: '-536870904') | 0 | crash | 3/6 Plausible | 1 | — | — |
| 258 | [#325149](https://github.com/microsoft/vscode/issues/325149) | Agent Mode fails with GitHub Enterprise auth - "thinking" forever / TypeError: terminated | 0 | correctness | 4/6 Traced | 1 | — | — |
| 259 | [#325664](https://github.com/microsoft/vscode/issues/325664) | "Open View" quick access: filtering by container name is case-sensitive | 0 | correctness | 5/6 Source-confirmed | 1 | — | — |
| 261 | [#325825](https://github.com/microsoft/vscode/issues/325825) | Configure Tools selection still does not persist in VS Code 1.128.0 | 0 | correctness | 5/6 Source-confirmed | 1 | — | — |
| 262 | [#326041](https://github.com/microsoft/vscode/issues/326041) | AH: agent edit does not show in a dirty file in the editor | 0 | correctness | — | 1 | — | — |
| 263 | [#326891](https://github.com/microsoft/vscode/issues/326891) | vscode_listCodeusages does not deliver requested references in order | 0 | correctness | 5/6 Source-confirmed | 1 | yes | — |
| 264 | [#326918](https://github.com/microsoft/vscode/issues/326918) | Non-actionable response and weak context continuity | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 265 | [#326960](https://github.com/microsoft/vscode/issues/326960) | Issues with the chat conversation | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 266 | [#326967](https://github.com/microsoft/vscode/issues/326967) | Mal texto y perdida de la tarea | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 267 | [#326968](https://github.com/microsoft/vscode/issues/326968) | to=multi_tool_use.parallel մեկնաբանություն 大发扑克json | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 268 | [#326989](https://github.com/microsoft/vscode/issues/326989) | [Error] unhandlederror-Agent host proxy is not available because no upstream agent host endpoint was configu... | 0 | papercut | 6/6 Confirmed | 1 | — | — |
| 272 | [#327625](https://github.com/microsoft/vscode/issues/327625) | Activating Error | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 273 | [#327678](https://github.com/microsoft/vscode/issues/327678) | Erro no agente | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 274 | [#327908](https://github.com/microsoft/vscode/issues/327908) | Issue with Github Copilot | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 275 | [#328189](https://github.com/microsoft/vscode/issues/328189) | Copilot reports tools are disabled by user even though I have them enabled in "Configure Tools" | 0 | correctness | 6/6 Confirmed | 1 | — | — |
| 276 | [#328386](https://github.com/microsoft/vscode/issues/328386) | Weird destructive copilot behavior | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 277 | [#145923](https://github.com/microsoft/vscode/issues/145923) | Up arrow in python debug console does not work as expected after using "Evaluate in Debug Console" | 1 | papercut | 2/6 Unverified | 0 | — | — |
| 278 | [#126257](https://github.com/microsoft/vscode/issues/126257) | function "setBreakPointsRequest" in the Debug Adapter is triggered to much | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 279 | [#144211](https://github.com/microsoft/vscode/issues/144211) | Debugger does not respect supportsDelayedStackTraceLoading false | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 280 | [#144532](https://github.com/microsoft/vscode/issues/144532) | JavaScript Debug Console mangles output that includes both CSS and Object specifiers | 0 | visual | 3/6 Plausible | 0 | — | — |
| 281 | [#152639](https://github.com/microsoft/vscode/issues/152639) | Duplicate entries in edit breakpoint and related submenus | 0 | papercut | 5/6 Source-confirmed | 0 | yes | — |
| 282 | [#153469](https://github.com/microsoft/vscode/issues/153469) | Debug fails to show debug toolbar and toggle status bar color | 0 | visual | 3/6 Plausible | 0 | — | — |
| 283 | [#154866](https://github.com/microsoft/vscode/issues/154866) | Expand object in debug panel messes up with scroll top | 0 | papercut | 5/6 Source-confirmed | 0 | — | — |
| 284 | [#161242](https://github.com/microsoft/vscode/issues/161242) | Dead debug state | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 285 | [#166183](https://github.com/microsoft/vscode/issues/166183) | Wrong session restored after main window closed while another instance was running in debugger | 0 | papercut | 5/6 Source-confirmed | 0 | yes | — |
| 286 | [#174488](https://github.com/microsoft/vscode/issues/174488) | Annoying warnings in launch.json for configs that don't apply to current platform. | 0 | papercut | 5/6 Source-confirmed | 0 | yes | — |
| 287 | [#174972](https://github.com/microsoft/vscode/issues/174972) | Run to Cursor and Add to Watch available in JSON settings file context menu | 0 | papercut | 5/6 Source-confirmed | 0 | yes | — |
| 288 | [#186561](https://github.com/microsoft/vscode/issues/186561) | Copying text from the debug console doesn't work quite right | 0 | papercut | 2/6 Unverified | 0 | — | — |
| 289 | [#206056](https://github.com/microsoft/vscode/issues/206056) | CSS for debug icons applies to TreeItem inline commands | 0 | visual | 5/6 Source-confirmed | 0 | yes | — |
| 290 | [#208289](https://github.com/microsoft/vscode/issues/208289) | MultiProvider is not supported for registerDebugConfigurationProvider Dynamic | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 291 | [#224676](https://github.com/microsoft/vscode/issues/224676) | Call-site sometimes off-screen when clicking thru (Python) call stack | 0 | papercut | 3/6 Plausible | 0 | — | — |
| 292 | [#224685](https://github.com/microsoft/vscode/issues/224685) | "Copy Call Stack" in Debug uses the wrong path separator when debugging cross platform | 0 | papercut | 5/6 Source-confirmed | 0 | yes | — |
| 293 | [#241262](https://github.com/microsoft/vscode/issues/241262) | Debug Hover Widget Height Is Computed Inconsistently | 0 | visual | 5/6 Source-confirmed | 0 | yes | — |
| 294 | [#241638](https://github.com/microsoft/vscode/issues/241638) | Inconsistent Debug Console Hover Styling: list.hoverBackground Applies, but list.hoverForeground Does Not | 0 | visual | 5/6 Source-confirmed | 0 | yes | — |
| 295 | [#251118](https://github.com/microsoft/vscode/issues/251118) | Chat: Inline context doesn't work inside parens | 0 | papercut | 5/6 Source-confirmed | 0 | yes | — |
| 297 | [#258342](https://github.com/microsoft/vscode/issues/258342) | `Chat: Show Chats` command doesn't respect Chat in Editor | 0 | papercut | 5/6 Source-confirmed | 0 | yes | — |
| 298 | [#264816](https://github.com/microsoft/vscode/issues/264816) | File attachments not rendered correctly | 0 | visual | 5/6 Source-confirmed | 0 | — | — |
| 300 | [#282923](https://github.com/microsoft/vscode/issues/282923) | Code Tab doesn't scroll up or down. | 0 | papercut | 5/6 Source-confirmed | 0 | — | — |
| 301 | [#283649](https://github.com/microsoft/vscode/issues/283649) | Extension tools should require confirmation by default if prepareInvocation is not implemented | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 302 | [#286277](https://github.com/microsoft/vscode/issues/286277) | Large pasted content in Copilot Chat silently dropped - message appears empty to AI | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 317 | [#291373](https://github.com/microsoft/vscode/issues/291373) | Chat thinking output displaying 4 backticks 'broke' chat for a second | 0 | visual | 3/6 Plausible | 0 | — | — |
| 321 | [#292155](https://github.com/microsoft/vscode/issues/292155) | Reviewed x files appears after subagent? | 0 | visual | 3/6 Plausible | 0 | — | — |
| 325 | [#299757](https://github.com/microsoft/vscode/issues/299757) | Agent Plugins: 404 error when fetching marketplace.json from awesome-copilot repo | 0 | papercut | 2/6 Unverified | 0 | — | — |
| 326 | [#299967](https://github.com/microsoft/vscode/issues/299967) | Failed to open chat session: Cannot read properties of undefined (reading 'match') | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 329 | [#301220](https://github.com/microsoft/vscode/issues/301220) | Locked `Explore.agent.md` frontmatter appears editable using `Configure Tools...` but actually isn't | 0 | papercut | 5/6 Source-confirmed | 0 | yes | — |
| 332 | [#301522](https://github.com/microsoft/vscode/issues/301522) | vscode use copilot chat get an error "vaildate string length" efftected can not promt. | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 333 | [#301582](https://github.com/microsoft/vscode/issues/301582) | create_file tool corrupts file content for Go files | 0 | correctness | 2/6 Unverified | 0 | — | — |
| 334 | [#301642](https://github.com/microsoft/vscode/issues/301642) | Too long answer | 0 | none | 3/6 Plausible | 0 | — | — |
| 335 | [#301725](https://github.com/microsoft/vscode/issues/301725) | Repeating Similar information many times. | 0 | none | 3/6 Plausible | 0 | — | — |
| 336 | [#301757](https://github.com/microsoft/vscode/issues/301757) | Copilot Tool Selector Closes When Scrolling | 0 | papercut | 2/6 Unverified | 0 | — | — |
| 337 | [#301788](https://github.com/microsoft/vscode/issues/301788) | Copilot Chat pending changes makes vscode slow | 0 | perf | 3/6 Plausible | 0 | — | — |
| 341 | [#302278](https://github.com/microsoft/vscode/issues/302278) | bugs | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 342 | [#302348](https://github.com/microsoft/vscode/issues/302348) | Can not leave session started by agentSessionWelcomePage | 0 | correctness | 6/6 Confirmed | 0 | — | — |
| 344 | [#302390](https://github.com/microsoft/vscode/issues/302390) | Debug Console: text selection is lost when scrolling up (virtualized list resets selection) | 0 | papercut | 4/6 Traced | 0 | — | — |
| 347 | [#302695](https://github.com/microsoft/vscode/issues/302695) | Russian languge broke LLM | 0 | none | 3/6 Plausible | 0 | — | — |
| 348 | [#303074](https://github.com/microsoft/vscode/issues/303074) | "Allow All Commands" not work in chat session | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 351 | [#303185](https://github.com/microsoft/vscode/issues/303185) | Sessions: Checkout button fails with error on cloud agent chat | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 354 | [#304068](https://github.com/microsoft/vscode/issues/304068) | Working with UTF-8 and languages with diacritics | 0 | none | 3/6 Plausible | 0 | — | — |
| 355 | [#304888](https://github.com/microsoft/vscode/issues/304888) | Inconsistency in tools definition for Copilot in VSCode and GitHub Copilot CLI | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 356 | [#304936](https://github.com/microsoft/vscode/issues/304936) | I have to modify my agents to allow them to use tools | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 362 | [#305638](https://github.com/microsoft/vscode/issues/305638) | 无法读取文件内容 | 0 | none | 3/6 Plausible | 0 | — | — |
| 365 | [#308833](https://github.com/microsoft/vscode/issues/308833) | Editing chats doesn't work properly | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 366 | [#309941](https://github.com/microsoft/vscode/issues/309941) | Bad chat loading rendering | 0 | visual | 4/6 Traced | 0 | yes | — |
| 368 | [#312308](https://github.com/microsoft/vscode/issues/312308) | Agents: Multiple issues > General/Sessions/Sub-sessions/PR Review | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 370 | [#312673](https://github.com/microsoft/vscode/issues/312673) | `chatagent` language mode reports false-positive "File not found" warnings for in-page Markdown anchor links | 0 | papercut | 5/6 Source-confirmed | 0 | — | — |
| 372 | [#313092](https://github.com/microsoft/vscode/issues/313092) | GPT 5.5 doesn't detect agent changes properly | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 375 | [#313222](https://github.com/microsoft/vscode/issues/313222) | validatePipeline Copilot agent tool fails with "No such remote 'origin'" when git remote is named differently | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 376 | [#313323](https://github.com/microsoft/vscode/issues/313323) | agents: Workspace Trust Dialog is not shown | 0 | correctness | 2/6 Unverified | 0 | — | — |
| 377 | [#313736](https://github.com/microsoft/vscode/issues/313736) | Call Stack visual selection can remain on previous thread after per-thread step, despite activeStackItem changing | 0 | visual | 4/6 Traced | 0 | — | — |
| 378 | [#313759](https://github.com/microsoft/vscode/issues/313759) | Lost conection to device | 0 | none | — | 0 | — | — |
| 380 | [#316243](https://github.com/microsoft/vscode/issues/316243) | Copilot CLI agent panel: CWD silently inherited from active terminal, not from open workspace | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 381 | [#316983](https://github.com/microsoft/vscode/issues/316983) | Bug: "tools: Tool names must be unique" Error when using Claude Sonnet 4.5 or 4.6 in Plan, Ask and Agent modes with the VSCode tool enabled | 0 | correctness | 4/6 Traced | 0 | yes | — |
| 382 | [#316997](https://github.com/microsoft/vscode/issues/316997) | [Bug] Incomplete Sanitization in searchIntent.ts: Unescaped Backtick Breaks Markdown Table Cell in Copilot Search Results | 0 | papercut | 4/6 Traced | 0 | yes | — |
| 383 | [#317270](https://github.com/microsoft/vscode/issues/317270) | Killing hidden terminals trigger model call | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 384 | [#317319](https://github.com/microsoft/vscode/issues/317319) | GitHub Copilot Chat is repeatedly attributed in extension host unresponsive profiles during agent sessions on Windows; hottest frames include tokenCount, baseMessageTokenCount, and _getFinalElementTree | 0 | perf | 3/6 Plausible | 0 | — | — |
| 385 | [#317500](https://github.com/microsoft/vscode/issues/317500) | Language model per-model settings are saved to the wrong provider group when multiple groups share the same vendor | 0 | correctness | 2/6 Unverified | 0 | — | — |
| 386 | [#317771](https://github.com/microsoft/vscode/issues/317771) | [BUG] No results returned for the `fileSearch` tool when querying a network drive, works fine when ommited | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 389 | [#318604](https://github.com/microsoft/vscode/issues/318604) | AgentHost: Remote session stops updating after connection change | 0 | correctness | — | 0 | — | — |
| 390 | [#318872](https://github.com/microsoft/vscode/issues/318872) | Copilot Chat debug file logging omits per-turn events for empty-window chat sessions | 0 | correctness | 2/6 Unverified | 0 | — | — |
| 393 | [#319929](https://github.com/microsoft/vscode/issues/319929) | Windows-style absolute paths still flagged as outside of workspace in GitHub Copilot | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 394 | [#320418](https://github.com/microsoft/vscode/issues/320418) | Copilot CLI: `create` tool hangs indefinitely for paths outside the workspace | 0 | freeze | 5/6 Source-confirmed | 0 | — | — |
| 396 | [#320476](https://github.com/microsoft/vscode/issues/320476) | mermaid block in Agents Window chat renders as `[Object object]` | 0 | visual | 3/6 Plausible | 0 | — | — |
| 397 | [#320635](https://github.com/microsoft/vscode/issues/320635) | Claude Sonnet 4.x Request Failed: 400 Tool names must be unique (bug, workaround) | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 398 | [#320716](https://github.com/microsoft/vscode/issues/320716) | Many other languages in non-sensical response from Copilot | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 402 | [#323141](https://github.com/microsoft/vscode/issues/323141) | Debug Play button can be hidden by making the view container to small | 0 | visual | 5/6 Source-confirmed | 0 | — | — |
| 404 | [#323811](https://github.com/microsoft/vscode/issues/323811) | New chat sessions always leak | 0 | perf | 5/6 Source-confirmed | 0 | — | — |
| 407 | [#324330](https://github.com/microsoft/vscode/issues/324330) | Start the agent host process earlier (prewarm) so local sessions appear quickly on window startup | 0 | perf | — | 0 | — | — |
| 411 | [#325381](https://github.com/microsoft/vscode/issues/325381) | Copilot agent regex search returns zero results for files outside workspace root | 0 | correctness | 4/6 Traced | 0 | — | — |
| 413 | [#325474](https://github.com/microsoft/vscode/issues/325474) | TypeError: .pendingRequests[0].request.message.parts: Converting circular structure to JSON | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 416 | [#326446](https://github.com/microsoft/vscode/issues/326446) | get_errors tool returns "No errors found" when filePaths targets a Kotlin file with diagnostics, but global query works | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 419 | [#326615](https://github.com/microsoft/vscode/issues/326615) | chat: hangs failing to ask permission to write file outside repo | 0 | correctness | 6/6 Confirmed | 0 | — | — |
| 420 | [#326710](https://github.com/microsoft/vscode/issues/326710) | Audit Copilot SDK events with agentId for subagent-safe handling | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 423 | [#327010](https://github.com/microsoft/vscode/issues/327010) | vscode_listCodeusages tool does not relay locations of references if the result set is too large | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 424 | [#327437](https://github.com/microsoft/vscode/issues/327437) | Agents window: background session terminals keep their renderer-side xterm alive, growing unbounded | 0 | perf | 5/6 Source-confirmed | 0 | — | — |
| 430 | [#328459](https://github.com/microsoft/vscode/issues/328459) | Background compaction / truncation appears broken in AHP | 0 | freeze | 6/6 Confirmed | 0 | — | — |
