...
Experimental themed view of [the flat ranking](vritant24.md); themes assigned by the review engine. Rank/score are the lane-wide values. Generated 2026-08-03 17:07 UTC.

## Bugs

### Context budgeting (10)
...
| 49 | [#311705](https://github.com/microsoft/vscode/issues/311705) | Copilot Chat with Ollama/BYOK uses nominal context_length for prompt budgeting and drops token usage in the context widget | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 55 | [#316402](https://github.com/microsoft/vscode/issues/316402) | The max context of OpenRouter Model is wrong, it should be 1M. | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 62 | [#321761](https://github.com/microsoft/vscode/issues/321761) | "Reserved for response" ignores `maxOutputTokens` for extension-contributed models (hard-coded to 8192) | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 75 | [#325436](https://github.com/microsoft/vscode/issues/325436) | BYOK custom endpoint (Responses API) sends truncated input to servers that do not store responses | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |

### Custom endpoint protocol (14)
...
| 35 | [#327597](https://github.com/microsoft/vscode/issues/327597) | kimi-k2.7-code generates tool_use IDs that block subsequent requests to Anthropic with HTTP 400 | 0 | correctness | 5/6 Source-confirmed | 2 | yes | — |
| 36 | [#328418](https://github.com/microsoft/vscode/issues/328418) | BYOK via Github Copilot Chat - 400 error on max-completion-token | 0 | correctness | 6/6 Confirmed | 2 | — | — |
| 38 | [#317503](https://github.com/microsoft/vscode/issues/317503) | BYOK to GHCP throws an error (GPT 5.3 Codex model) | 0 | correctness | 6/6 Confirmed | 1 | — | — |
...
| 57 | [#318101](https://github.com/microsoft/vscode/issues/318101) | Improve Azure OpenAI URL Handling in the BYOK Provider | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 66 | [#323172](https://github.com/microsoft/vscode/issues/323172) | BYOK CustomEndpoint Model only thinks, cannot parse or strip `delta.reasoning` | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 76 | [#326597](https://github.com/microsoft/vscode/issues/326597) | Extension-contributed language model providers lose historical thinking needed for vLLM preserve_thinking | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
...
| 39 | [#318415](https://github.com/microsoft/vscode/issues/318415) | BYOK UI: Group name should appear in UI of `Manage Language Models` | 0 | visual | 5/6 Source-confirmed | 1 | yes | — |
| 40 | [#318417](https://github.com/microsoft/vscode/issues/318417) | BYOK UI: Last model should not be selected after removing BYOK models | 0 | visual | 3/6 Plausible | 1 | — | — |
| 52 | [#315615](https://github.com/microsoft/vscode/issues/315615) | Models Management: Configure does nothing | 0 | papercut | 2/6 Unverified | 0 | — | — |
| 53 | [#315837](https://github.com/microsoft/vscode/issues/315837) | Models Management: Rendering Issues | 0 | visual | 3/6 Plausible | 0 | — | — |
| 58 | [#318408](https://github.com/microsoft/vscode/issues/318408) | Selected model in a session isn't always preserved on Reload | 0 | correctness | 4/6 Traced | 0 | — | — |
| 63 | [#322436](https://github.com/microsoft/vscode/issues/322436) | Double Copilot sections appear in manage models view | 0 | visual | 3/6 Plausible | 0 | — | — |
| 69 | [#324755](https://github.com/microsoft/vscode/issues/324755) | Anthropic Provider not showing in Linux | 0 | none | 3/6 Plausible | 0 | — | — |
| 78 | [#327460](https://github.com/microsoft/vscode/issues/327460) | Chat Languages Models missing | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 79 | [#327644](https://github.com/microsoft/vscode/issues/327644) | [Chat Model Picker] Duplicate 'copilot' group in the model list | 0 | visual | 5/6 Source-confirmed | 0 | — | — |
...
| 47 | [#264959](https://github.com/microsoft/vscode/issues/264959) | Live editing OAI Compatible setting doesn't reflect changes in model picker | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
| 59 | [#319131](https://github.com/microsoft/vscode/issues/319131) | Copilot agent model settings silently ignored when model ID format doesn't match internal ID — falls back to system default with no warning | 0 | papercut | 4/6 Traced | 0 | — | — |
| 70 | [#325069](https://github.com/microsoft/vscode/issues/325069) | Custom chat model settings collide when multiple providers expose the same model id | 0 | correctness | 4/6 Traced | 0 | — | — |
| 77 | [#326602](https://github.com/microsoft/vscode/issues/326602) | Clicking migrate on Ollama deprectaed setting leads to an error | 0 | papercut | 4/6 Traced | 0 | — | — |
| 80 | [#328055](https://github.com/microsoft/vscode/issues/328055) | Agent host can't list model in different custom endpoints but model have same id | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 81 | [#328277](https://github.com/microsoft/vscode/issues/328277) | Changing the reasoning effort causes overwrite of provider entry in chatLanguageModels.json | 0 | data-loss | 5/6 Source-confirmed | 0 | — | — |
...
| 43 | [#320537](https://github.com/microsoft/vscode/issues/320537) | BYOK dialog shows up, despite being signed in | 0 | visual | 3/6 Plausible | 1 | — | — |
| 46 | [#328422](https://github.com/microsoft/vscode/issues/328422) | LanguageModelError - NotFound | 0 | correctness | 6/6 Confirmed | 1 | — | — |
| 67 | [#324245](https://github.com/microsoft/vscode/issues/324245) | BYOK: Can't use local model when VS Code Window is started without internet | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 71 | [#325186](https://github.com/microsoft/vscode/issues/325186) | Sending a chat when not signed in has an unhelpful error message | 0 | papercut | 5/6 Source-confirmed | 0 | — | — |
...
| 51 | [#314968](https://github.com/microsoft/vscode/issues/314968) | Copilot does not support MCP within local Ollama | 0 | none | 3/6 Plausible | 0 | — | — |
| 61 | [#321196](https://github.com/microsoft/vscode/issues/321196) | BYOK Responses API path does not stream `apply_patch` argument deltas to the tool UI | 0 | visual | 5/6 Source-confirmed | 0 | — | — |
| 65 | [#323102](https://github.com/microsoft/vscode/issues/323102) | Copilot Chat: agent request crashes with "Cannot read properties of undefined (reading 'type')" in countToolTokens when a tool input schema uses top-level JSON-Schema if/then (BYOK / custom model) | 0 | correctness | 5/6 Source-confirmed | 0 | yes | — |
...
| # | Issue | Title | 👍 | Severity | Rating | Score | Agent-fixable | Draft PR |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 41 | [#318467](https://github.com/microsoft/vscode/issues/318467) | Todos: Background todo agent creates completed todos during plan agent runs | 0 | correctness | 3/6 Plausible | 1 | — | — |
| 48 | [#299858](https://github.com/microsoft/vscode/issues/299858) | stale checklist | 0 | none | 3/6 Plausible | 0 | — | — |
| 50 | [#313520](https://github.com/microsoft/vscode/issues/313520) | Bug: `todo` tool not available to subAgents even when explicitly provided via frontmatter | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
| 54 | [#315911](https://github.com/microsoft/vscode/issues/315911) | Background todo creates completed todo items immediately | 0 | correctness | 3/6 Plausible | 0 | — | — |
| 56 | [#317054](https://github.com/microsoft/vscode/issues/317054) | model duplicating todo tool text outside tool | 0 | correctness | 3/6 Plausible | 0 | — | — |
...
| 68 | [#324509](https://github.com/microsoft/vscode/issues/324509) | Background todo agent experiment silently disables `manage_todo_list`, breaking custom instructions and workflows | 0 | correctness | 5/6 Source-confirmed | 0 | — | — |
...
| 37 | [#317414](https://github.com/microsoft/vscode/issues/317414) | [VS Code 1.120+] onDidChangeLanguageModelChatInformation EventEmitter presence causes all LM providers to collapse into Azure | 0 | correctness | 3/6 Plausible | 1 | — | — |
...
| 60 | [#319886](https://github.com/microsoft/vscode/issues/319886) | Ollama gemma model  Copilot adapter layer | 0 | none | 3/6 Plausible | 0 | — | — |
| 73 | [#325216](https://github.com/microsoft/vscode/issues/325216) | "No provider registered" log spam | 0 | papercut | 5/6 Source-confirmed | 0 | yes | — |

## Feature requests

### Custom model providers (10)
